 ...
 * @version V1.0
 */
public class MyPropertyEditorRegister implements PropertyEditorRegistrar,WebBindingInitializer {

private Logger logger = LoggerFactory.getLogger(MyPropertyEditorRegister.class);
	/**
