...
public class InitializingInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
        ...
        logger.info("entering postHandle ... ");
		...
		logger.info("entered preHandle  ..."+log.toString());
	...
	public void postHandle(HttpServletRequest request,
        ...
        logger.info("entered postHandle  , httpPath = "+httpPath);
	...
	public void afterCompletion(HttpServletRequest request,
			...
			throws Exception {
        logger.info("entering afterCompletion ... ");
		super.afterCompletion(request, response, handler, ex);
        logger.info("entered afterCompletion ... ");
	}

	@Override
	public void afterConcurrentHandlingStarted(HttpServletRequest request,
			HttpServletResponse response, Object handler) throws Exception {
        logger.info("entering afterConcurrentHandlingStarted ... ");
		super.afterConcurrentHandlingStarted(request, response, handler);
        logger.info("entered afterConcurrentHandlingStarted ... ");
