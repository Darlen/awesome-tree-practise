 ...
 * @version V1.0
 */
public class MyPropertyEditorRegistrar implements org.springframework.beans.PropertyEditorRegistrar,
		WebBindingInitializer {
private Logger logger = LoggerFactory.getLogger(MyPropertyEditorRegistrar.class);
	/**
	...
	public void registerCustomEditors(PropertyEditorRegistry registry) {
        logger.info("entering registerCustomEditors...");
		...
		registry.registerCustomEditor(String.class, new StringTrimmerEditor(
				false));
        logger.info("entered registerCustomEditors...");
	...
	public void initBinder(WebDataBinder binder, WebRequest request) {
        ...
        logger.info("entered initBinder...");
